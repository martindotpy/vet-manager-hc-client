...
//GET /api/v0/patient/race
export type racesAllResponse = {
  message: string;
  content: RaceResponseEntity[];
}

//GET /api/v0/patient/species
export type speciesAllResponse = {
  message: string;
  content: SpeciesResponseEntity[];
}
